...
# lambda
# lambda_values = [1, 5, 10, 15, 20, 25, 50, 75, 100]

# for lam in lambda_values:
lam = 45

# combined data
adata_xenium = sc.read_h5ad('/home/caleb/Desktop/improvedgenepred/data/breastcancer_poisson_noise/xenium_data_poissonlambda' + str(lam) + '.h5ad')
# adata_visium = sc.read_h5ad('/home/caleb/Desktop/improvedgenepred/data/breastcancer_poisson_noise/visium_data_poissonlambda' + str(lam) + '.h5ad')
...
# patches
# with open('/home/caleb/Desktop/improvedgenepred/data/breastcancer_poisson_noise/visium_patches_poissonlambda' + str(lam) + '.pkl', 'rb') as f:
#     aligned_visium_dictionary = pickle.load(f)

with open('/home/caleb/Desktop/improvedgenepred/data/breastcancer_poisson_noise/xenium_patches_poissonlambda' + str(lam) + '.pkl', 'rb') as f:
...
epochs = 150
model = GeneExpressionPredictor(output_size, dropout_rate=0.2, method = method, lossplot_save_file = f'/home/caleb/Desktop/improvedgenepred/results/poisson_noise/breastcancer_' + method + '_image' + image_version + '_seed' + str(seed_val) + '_' + edit + '_lossplot.png')
print(model)
...
torch.save(model.state_dict(), f"/home/caleb/Desktop/improvedgenepred/results/poisson_noise/model_{method}data_image{image_version}_epochs{epochs}_seed{seed_val}_{edit}.pth")
...
if method == "visium":
    correlation_df, adata_pred = evaluate_model_validation(
        ...
        model,
        adata_visium,
        output_file=f'/home/caleb/Desktop/improvedgenepred/results/poisson_noise/breastcancer_{method}data_{image_version}image_seed{seed_val}_test_correlation_summary_{edit}.txt'
    )
else:
    correlation_df, adata_pred = evaluate_model_validation(
        data_module,
...
correlation_df.to_csv('/home/caleb/Desktop/improvedgenepred/results/poisson_noise/breastcancer_' + method + 'data_' + image_version + 'image_seed' + str(seed_val) + '_test_correlation_df_' + edit + '.csv')
...
if method == "visium":
    correlation_df_full, adata_pred_full = evaluate_model_validation(
        ...
        model,
        adata_visium,
        output_file=f'/home/caleb/Desktop/improvedgenepred/results/poisson_noise/breastcancer_{method}data_{image_version}image_seed{seed_val}_full_correlation_summary_{edit}.txt'
    )
else:
    correlation_df_full, adata_pred_full = evaluate_model_validation(
        data_module_full,
...
correlation_df_full.to_csv('/home/caleb/Desktop/improvedgenepred/results/poisson_noise/breastcancer_' + method + 'data_' + image_version + 'image_seed' + str(seed_val) + '_full_correlation_df_' + edit + '.csv')
...
if image_version == "visium":
    # evaluate the model
    correlation_df2, adata_pred2 = evaluate_model_validation(data_module_rep2, model, adata_visium_rep2, output_file=f'/home/caleb/Desktop/improvedgenepred/results/poisson_noise/breastcancer_{method}data_{image_version}image_seed{seed_val}_rep2_correlation_summary_{edit}.txt')
else:
    # evaluate the model
    correlation_df2, adata_pred2 = evaluate_model_validation(data_module_rep2, model, adata_xenium_rep2, output_file=f'/home/caleb/Desktop/improvedgenepred/results/poisson_noise/breastcancer_{method}data_{image_version}image_seed{seed_val}_rep2_correlation_summary_{edit}.txt')
...
correlation_df2.to_csv('/home/caleb/Desktop/improvedgenepred/results/poisson_noise/breastcancer_' + method + 'data_' + image_version + 'image_seed' + str(seed_val) + '_rep2_correlation_df_' + edit + '.csv')

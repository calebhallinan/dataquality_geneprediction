...
# combined data
adata_xenium = sc.read_h5ad('/home/caleb/Desktop/improvedgenepred/data/breastcancer_sample1_rep1_aligned_tovisiumimage/xeniumdata_visiumimage_data_tiff.h5ad')
adata_visium = sc.read_h5ad('/home/caleb/Desktop/improvedgenepred/data/breastcancer_sample1_rep1_aligned_tovisiumimage/visiumdata_visiumimage_data_tiff.h5ad')
...
# patches
with open('/home/caleb/Desktop/improvedgenepred/data/breastcancer_sample1_rep1_aligned_tovisiumimage/visiumdata_visiumimage_patches_tiff.pkl', 'rb') as f:
    aligned_visium_dictionary = pickle.load(f)

with open('/home/caleb/Desktop/improvedgenepred/data/breastcancer_sample1_rep1_aligned_tovisiumimage/xeniumdata_visiumimage_patches_tiff.pkl', 'rb') as f:
...
# combined data
adata_xenium = sc.read_h5ad('/home/caleb/Desktop/improvedgenepred/data/breastcancer_sample1_rep1_aligned_toxeniumimage/xeniumdata_xeniumimage_data_tiff.h5ad')
adata_visium = sc.read_h5ad('/home/caleb/Desktop/improvedgenepred/data/breastcancer_sample1_rep1_aligned_toxeniumimage/visiumdata_xeniumimage_data_tiff.h5ad')
...
# patches
with open('/home/caleb/Desktop/improvedgenepred/data/breastcancer_sample1_rep1_aligned_toxeniumimage/visiumdata_xeniumimage_patches_tiff.pkl', 'rb') as f:
    aligned_visium_dictionary = pickle.load(f)

with open('/home/caleb/Desktop/improvedgenepred/data/breastcancer_sample1_rep1_aligned_toxeniumimage/xeniumdata_xeniumimage_patches_tiff.pkl', 'rb') as f:
    aligned_xenium_dictionary = pickle.load(f)
...
# # # plotRaster(adata_xenium.uns["spatial"], aligned_xenium_dictionary, color_by='gene_expression', gene_name='HDC')
...
# for seed_val in [42]:
    ...
    epochs = 50
    model = GeneExpressionPredictor(output_size, dropout_rate=0.2, method = method, lossplot_save_file = f'/home/caleb/Desktop/improvedgenepred/results/tiff/breastcancer_' + method + 'data_' + image_version + 'image_seed' + str(seed_val) + '_' + edit + '_lossplot.png')
    print(model)

    # Trainer initialization
    trainer = pl.Trainer(max_epochs=epochs, accelerator = "gpu", devices=1, precision="16-mixed", enable_checkpointing=False, logger=False)

    # Train the model
    trainer.fit(model, data_module)

    # Save the model based on resolution and file name
    torch.save(model.state_dict(), f"/home/caleb/Desktop/improvedgenepred/results/tiff/model_{method}data_{image_version}image_epochs{epochs}_seed{seed_val}_{edit}.pth")
    ...
    # # Load the model
    # model.load_state_dict(torch.load(f"/home/caleb/Desktop/improvedgenepred/results/tiff/model_{method}data_{image_version}image_epochs{epochs}_seed{seed_val}_{edit}.pth"))
    ...
    if method == "visium":
        correlation_df, adata_pred = evaluate_model_validation(
            ...
            model,
            adata_visium,
            output_file=f'/home/caleb/Desktop/improvedgenepred/results/tiff/breastcancer_{method}data_{image_version}image_seed{seed_val}_test_correlation_summary_{edit}.txt'
        )
    else:
        correlation_df, adata_pred = evaluate_model_validation(
            data_module,
    ...
    correlation_df.to_csv('/home/caleb/Desktop/improvedgenepred/results/tiff/breastcancer_' + method + 'data_' + image_version + 'image_seed' + str(seed_val) + '_test_correlation_df_' + edit + '.csv')
    ...
    if method == "visium":
        correlation_df_full, adata_pred_full = evaluate_model_validation(
            ...
            model,
            adata_visium,
            output_file=f'/home/caleb/Desktop/improvedgenepred/results/tiff/breastcancer_{method}data_{image_version}image_seed{seed_val}_full_correlation_summary_{edit}.txt'
        )
    else:
        correlation_df_full, adata_pred_full = evaluate_model_validation(
            data_module_full,
    ...
    # adata_pred_full.write('/home/caleb/Desktop/improvedgenepred/results/tiff/breastcancer_' + method + '_image' + image_version + '_seed' + str(seed_val) + '_aligned_adata_pred_full_' + edit + '.h5ad')
    correlation_df_full.to_csv('/home/caleb/Desktop/improvedgenepred/results/tiff/breastcancer_' + method + 'data_' + image_version + 'image_seed' + str(seed_val) + '_full_correlation_df_' + edit + '.csv')
    ...
    # adata_xenium_rep2.uns['spatial'].shape
    # adata_xenium.uns['spatial'].shape
    ...
    if image_version == "visium":
        # evaluate the model
        correlation_df2, adata_pred2 = evaluate_model_validation(data_module_rep2, model, adata_visium_rep2, output_file=f'/home/caleb/Desktop/improvedgenepred/results/tiff/breastcancer_{method}data_{image_version}image_seed{seed_val}_rep2_correlation_summary_{edit}.txt')
    else:
        # evaluate the model
        correlation_df2, adata_pred2 = evaluate_model_validation(data_module_rep2, model, adata_xenium_rep2, output_file=f'/home/caleb/Desktop/improvedgenepred/results/tiff/breastcancer_{method}data_{image_version}image_seed{seed_val}_rep2_correlation_summary_{edit}.txt')
    ...
    correlation_df2.to_csv('/home/caleb/Desktop/improvedgenepred/results/tiff/breastcancer_' + method + 'data_' + image_version + 'image_seed' + str(seed_val) + '_rep2_correlation_df_' + edit + '.csv')

...
# for seed_val in [42]:
    ...
    epochs = 15
    model = UNIGeneExpressionPredictor(output_size, dropout_rate=0.2, method = method, lossplot_save_file = f'/home/caleb/Desktop/improvedgenepred/results/UNI/breastcancer_' + method + 'data_' + image_version + 'image_seed' + str(seed_val) + '_' + edit + '_lossplot.png')
    print(model)
    ...
    torch.save(model.state_dict(), f"/home/caleb/Desktop/improvedgenepred/results/UNI/model_{method}data_{image_version}image_epochs{epochs}_seed{seed_val}_{edit}.pth")
    ...
    # # Load the model
    # model.load_state_dict(torch.load(f"/home/caleb/Desktop/improvedgenepred/results/UNI/model_{method}data_{image_version}image_epochs{epochs}_seed{seed_val}_{edit}.pth"))
    ...
    if method == "visium":
        correlation_df, adata_pred = evaluate_model_validation(
            ...
            model,
            adata_visium,
            output_file=f'/home/caleb/Desktop/improvedgenepred/results/UNI/breastcancer_{method}data_{image_version}image_seed{seed_val}_test_correlation_summary_{edit}.txt'
        )
    else:
        correlation_df, adata_pred = evaluate_model_validation(
            data_module,
    ...
    correlation_df.to_csv('/home/caleb/Desktop/improvedgenepred/results/UNI/breastcancer_' + method + 'data_' + image_version + 'image_seed' + str(seed_val) + '_test_correlation_df_' + edit + '.csv')
    ...
    if method == "visium":
        correlation_df_full, adata_pred_full = evaluate_model_validation(
            ...
            model,
            adata_visium,
            output_file=f'/home/caleb/Desktop/improvedgenepred/results/UNI/breastcancer_{method}data_{image_version}image_seed{seed_val}_full_correlation_summary_{edit}.txt'
        )
    else:
        correlation_df_full, adata_pred_full = evaluate_model_validation(
            data_module_full,
    ...
    # adata_pred_full.write('/home/caleb/Desktop/improvedgenepred/results/UNI/breastcancer_' + method + '_image' + image_version + '_seed' + str(seed_val) + '_aligned_adata_pred_full_' + edit + '.h5ad')
    correlation_df_full.to_csv('/home/caleb/Desktop/improvedgenepred/results/UNI/breastcancer_' + method + 'data_' + image_version + 'image_seed' + str(seed_val) + '_full_correlation_df_' + edit + '.csv')
    ...
    if image_version == "visium":
        # evaluate the model
        correlation_df2, adata_pred2 = evaluate_model_validation(data_module_rep2, model, adata_visium_rep2, output_file=f'/home/caleb/Desktop/improvedgenepred/results/UNI/breastcancer_{method}data_{image_version}image_seed{seed_val}_rep2_correlation_summary_{edit}.txt')
    else:
        # evaluate the model
        correlation_df2, adata_pred2 = evaluate_model_validation(data_module_rep2, model, adata_xenium_rep2, output_file=f'/home/caleb/Desktop/improvedgenepred/results/UNI/breastcancer_{method}data_{image_version}image_seed{seed_val}_rep2_correlation_summary_{edit}.txt')
    ...
    correlation_df2.to_csv('/home/caleb/Desktop/improvedgenepred/results/UNI/breastcancer_' + method + 'data_' + image_version + 'image_seed' + str(seed_val) + '_rep2_correlation_df_' + edit + '.csv')

...
# off_targets = ["CD79B", "CEACAM6", "SCGB2A1", "APOBEC3A","KLRC1", "KRT7","TUBB2B", "ACTG2","CD8B","ZNF562","TPSAB1","C1QA","KRT8","APOBEC3B", "KRT6B","ADH1B","AKR1C1","FCGR3A","POLR2J3","AQP1","KRT14"]
...
# # remove off-targets from the data
# adata_xenium = adata_xenium[:,~adata_xenium.var.index.isin(off_targets)]
# adata_visium = adata_visium[:,~adata_visium.var.index.isin(off_targets)]
...
#     aligned_visium_dictionary[i] = aligned_visium_dictionary[i][:,~aligned_visium_dictionary[i].var.index.isin(off_targets)]
# for i in aligned_xenium_dictionary:
#     aligned_xenium_dictionary[i] = aligned_xenium_dictionary[i][:,~aligned_xenium_dictionary[i].var.index.isin(off_targets)]
...
epochs = 150
model = GeneExpressionPredictor(output_size, dropout_rate=0.2, method = method, lossplot_save_file = f'/home/caleb/Desktop/improvedgenepred/results/off_targets/breastcancer_' + method + 'data_' + image_version + 'image_seed' + str(seed_val) + '_' + edit + '_lossplot.png')
print(model)
...
torch.save(model.state_dict(), f"/home/caleb/Desktop/improvedgenepred/results/off_targets/model_{method}data_{image_version}image_epochs{epochs}_seed{seed_val}_{edit}.pth")
...
# # Load the model
# model.load_state_dict(torch.load(f"/home/caleb/Desktop/improvedgenepred/results/off_targets/model_{method}data_{image_version}image_epochs{epochs}_seed{seed_val}_{edit}.pth"))
...
if method == "visium":
    save_per_patch_results(data_module, model, adata_visium, output_file=f'/home/caleb/Desktop/improvedgenepred/results/off_targets/breastcancer_{method}data_{image_version}image_seed{seed_val}_test_per_patch_results_{edit}.csv') 
else:
    save_per_patch_results(data_module, model, adata_xenium, output_file=f'/home/caleb/Desktop/improvedgenepred/results/off_targets/breastcancer_{method}data_{image_version}image_seed{seed_val}_test_per_patch_results_{edit}.csv')
...
if method == "visium":
    correlation_df, adata_pred = evaluate_model_validation(
        ...
        model,
        adata_visium,
        output_file=f'/home/caleb/Desktop/improvedgenepred/results/off_targets/breastcancer_{method}data_{image_version}image_seed{seed_val}_test_correlation_summary_{edit}.txt'
    )
else:
    correlation_df, adata_pred = evaluate_model_validation(
        data_module,
...
correlation_df.to_csv('/home/caleb/Desktop/improvedgenepred/results/off_targets/breastcancer_' + method + 'data_' + image_version + 'image_seed' + str(seed_val) + '_test_correlation_df_' + edit + '.csv')
...
#         model,
#         adata_visium,
#         output_file=f'/home/caleb/Desktop/improvedgenepred/results/off_targets/breastcancer_{method}data_{image_version}image_seed{seed_val}_full_correlation_summary_{edit}.txt'
#     )
# else:
#     correlation_df_full, adata_pred_full = evaluate_model_validation(
#         data_module_full,
...
# adata_pred_full.write('/home/caleb/Desktop/improvedgenepred/results/off_targets/breastcancer_' + method + '_image' + image_version + '_seed' + str(seed_val) + '_aligned_adata_pred_full_' + edit + '.h5ad')
# correlation_df_full.to_csv('/home/caleb/Desktop/improvedgenepred/results/off_targets/breastcancer_' + method + 'data_' + image_version + 'image_seed' + str(seed_val) + '_full_correlation_df_' + edit + '.csv')
...
# if image_version == "visium":
#     # evaluate the model
#     correlation_df2, adata_pred2 = evaluate_model_validation(data_module_rep2, model, adata_visium_rep2, output_file=f'/home/caleb/Desktop/improvedgenepred/results/off_targets/breastcancer_{method}data_{image_version}image_seed{seed_val}_rep2_correlation_summary_{edit}.txt')
# else:
#     # evaluate the model
#     correlation_df2, adata_pred2 = evaluate_model_validation(data_module_rep2, model, adata_xenium_rep2, output_file=f'/home/caleb/Desktop/improvedgenepred/results/off_targets/breastcancer_{method}data_{image_version}image_seed{seed_val}_rep2_correlation_summary_{edit}.txt')
...
# correlation_df2.to_csv('/home/caleb/Desktop/improvedgenepred/results/off_targets/breastcancer_' + method + 'data_' + image_version + 'image_seed' + str(seed_val) + '_rep2_correlation_df_' + edit + '.csv')

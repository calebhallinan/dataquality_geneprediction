...
# save to csv
pd.Series(common_genes).to_csv("shared_genes_visiumhd_xenium_cosmx_stereoseq_OV.csv")
...
pd.Series(top_2000_hvgs_names).to_csv("shared_genes_visiumhd_xenium_cosmx_stereoseq_OV.csv", index=False)

...
adata_visiumhd = sc.read_h5ad('/home/caleb/Desktop/improvedgenepred/data/OV/visiumhd_adata_OV.h5ad')

# read in image
image_visiumhd = Image.open("/home/caleb/Desktop/improvedgenepred/data/OV/visiumhd_image_OV.tif")
...
shared_genes = list(pd.read_csv("shared_genes_visiumhd_xenium_cosmx_stereoseq_OV.csv", index_col=0).index)
...
# read in adata objects
adata_xenium = sc.read_h5ad('/home/caleb/Desktop/improvedgenepred/data/OV/xenium_adata_OV.h5ad')

# read in image
image_xenium = Image.open("/home/caleb/Desktop/improvedgenepred/data/OV/xenium_image_OV.tif")
...
# read in adata objects
adata_cosmx = sc.read_h5ad('/home/caleb/Desktop/improvedgenepred/data/OV/cosmx_adata_OV.h5ad')

# read in image
image_cosmx = Image.open("/home/caleb/Desktop/improvedgenepred/data/OV/cosmx_image_OV.tif")
...
# read in adata objects
adata_stereoseq = sc.read_h5ad('/home/caleb/Desktop/improvedgenepred/data/OV/stereoseq_adata_OV.h5ad')

# read in image
image_stereoseq = Image.open("/home/caleb/Desktop/improvedgenepred/data/OV/stereoseq_image_OV.tif")
...
adata_stereoseq = adata_stereoseq[:,shared_genes]
print(adata_stereoseq.shape)
...
# visiumhd_combined.write(f"/home/caleb/Desktop/improvedgenepred/data/OV/{method}_data_{patch_size}.h5ad")

# # save the patches aligned_visium
# with open(f'/home/caleb/Desktop/improvedgenepred/data/OV/{method}_patches_{patch_size}.pkl', 'wb') as f:
#     pickle.dump(patches_visiumhd, f)


# plotRaster(visiumhd_combined.uns["spatial"], patches_visiumhd, color_by='gene_expression', gene_name='GLDN')
...
# xenium_combined.write(f"/home/caleb/Desktop/improvedgenepred/data/OV/xenium_data_{patch_size}.h5ad")

# # save the patches aligned_visium
# with open(f'/home/caleb/Desktop/improvedgenepred/data/OV/xenium_patches_{patch_size}.pkl', 'wb') as f:
...
# cosmx_combined.write(f"/home/caleb/Desktop/improvedgenepred/data/OV/cosmx_data_{patch_size}.h5ad")

# # save the patches aligned_visium
# with open(f'/home/caleb/Desktop/improvedgenepred/data/OV/cosmx_patches_{patch_size}.pkl', 'wb') as f:
...
stereoseq_combined.write(f"/home/caleb/Desktop/improvedgenepred/data/OV/stereoseq_data_{patch_size}.h5ad")

# save the patches aligned_visium
with open(f'/home/caleb/Desktop/improvedgenepred/data/OV/stereoseq_patches_{patch_size}.pkl', 'wb') as f:

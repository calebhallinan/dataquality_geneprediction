...
shared_genes = list(pd.read_csv("shared_genes_visiumhd_xenium_cosmx_stereoseq_HCC.csv", index_col=0).index)
...
# visiumhd_combined.write(f"/home/caleb/Desktop/improvedgenepred/data/HCC/{method}_data_{patch_size}.h5ad")

# # save the patches aligned_visium
# with open(f'/home/caleb/Desktop/improvedgenepred/data/HCC/{method}_patches_{patch_size}.pkl', 'wb') as f:
...
# xenium_combined.write(f"/home/caleb/Desktop/improvedgenepred/data/HCC/xenium_data_{patch_size}.h5ad")

# # save the patches aligned_visium
# with open(f'/home/caleb/Desktop/improvedgenepred/data/HCC/xenium_patches_{patch_size}.pkl', 'wb') as f:
...
cosmx_combined.write(f"/home/caleb/Desktop/improvedgenepred/data/HCC/cosmx_data_{patch_size}.h5ad")

# save the patches aligned_visium
with open(f'/home/caleb/Desktop/improvedgenepred/data/HCC/cosmx_patches_{patch_size}.pkl', 'wb') as f:
...
stereoseq_combined.write(f"/home/caleb/Desktop/improvedgenepred/data/HCC/stereoseq_data_{patch_size}.h5ad")

# save the patches aligned_visium
with open(f'/home/caleb/Desktop/improvedgenepred/data/HCC/stereoseq_patches_{patch_size}.pkl', 'wb') as f:

...
adata_patches_visium = rasterizeGeneExpression_topatches_basedoncenters(adata_visium.uns['spatial'], adata_visium, adata_visium.obsm['spatial'], patch_size=resolution, aggregation='sum', visium=False)
...
plt.imshow(aligned_xenium["patch_100"].uns['spatial'])
len(aligned_xenium)
len(aligned_visium)
...
plotRaster(combined_aligned_visium.uns['spatial'], aligned_visium, color_by='gene_expression', gene_name="HDC")
...
# save all the data
combined_aligned_visium.write("/home/caleb/Desktop/improvedgenepred/data/breastcancer_sample1_rep1_aligned_tovisiumimage/visium_data_full.h5ad")
combined_aligned_xenium.write("/home/caleb/Desktop/improvedgenepred/data/breastcancer_sample1_rep1_aligned_tovisiumimage/xenium_data_full.h5ad")

# save the patches aligned_visium
with open('/home/caleb/Desktop/improvedgenepred/data/breastcancer_sample1_rep1_aligned_tovisiumimage/visium_patches_full.pkl', 'wb') as f:
    pickle.dump(aligned_visium, f)

# # save the patches aligned_xenium
with open('/home/caleb/Desktop/improvedgenepred/data/breastcancer_sample1_rep1_aligned_tovisiumimage/xenium_patches_full.pkl', 'wb') as f:
